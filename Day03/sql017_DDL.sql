...
/*
    ...
    예(username : CHAR(10)) 'asd'
    CHAR(10) = 'asd       '이름을 넣고 10개의 자리중 빈곳은 전부 스페이스 입력 ' '
    VARCHAR(10) = 'asd' 이름을 넣고 10개의 자리중 빈곳은 전부 없앰
...
CREATE TABLE NewBook(
    ...
    price INT DEFAULT 10000 CHECK(price > 1000), --기본값 제약조건
